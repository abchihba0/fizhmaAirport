...
//ну мне очевидно нужны какие-то коммиты
// тяжело быть программистом
// мне надо заниматься программированием
// мне надо заниматься учёбой
// учёба == уёба
// ладно, пока хватит коммитов
int main() {
